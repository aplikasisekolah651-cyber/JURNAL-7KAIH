    ...
    <div className="space-y-4 pb-8">
        ...
        <div className="relative z-10 flex flex-col md:flex-row md:items-center md:justify-between gap-4">
          <div className="space-y-1">
            ...
            <p className="text-slate-300 text-xs max-w-xl">
              Catat rutinitas 7 Kebiasaan Anak Indonesia Hebat setiap hari untuk menumbuhkan karakter mulia dan disiplin mandiri.
            </p>
          </div>
      ...
      <div className="flex items-center justify-between gap-2 border-b border-slate-200 dark:border-slate-800 pb-1.5">
        <div className="flex items-center gap-1.5">
          ...
          >
            📜 Riwayat & Validasi ({studentHistory.length})
          </button>
        </div>

        {/* Date Selector */}
        <div className="flex items-center gap-1.5 bg-white dark:bg-[#1E293B] px-2.5 py-1 rounded-lg border border-slate-200 dark:border-slate-800 shadow-xs">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-between gap-3 p-3 bg-slate-50 dark:bg-[#1E293B]/70 border border-slate-200 dark:border-slate-800 rounded-xl">
            ...
            <div className="flex items-center gap-2 w-full sm:w-auto">
              <button
                ...
                disabled={isSaving}
                className="w-full sm:w-auto flex items-center justify-center gap-1.5 px-4 py-2 rounded-lg bg-indigo-600 hover:bg-indigo-700 text-white text-xs font-semibold shadow-xs transition-all duration-200 active:scale-95 disabled:opacity-50"
              >
